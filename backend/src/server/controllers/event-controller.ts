...
class EventController {
    ...
    async updateDetails(request: Request, response: Response) {
        ...
        const details_in_text = fs
            .readFileSync(path.resolve(details.path))
            .toString('utf-8');

        const eventRepository = new EventRepository();
        const updateEventDetailsUsecase = new UpdateEventDetailsUsecase(
            eventRepository
        );

        await updateEventDetailsUsecase.execute({
            event_id,
            details: details_in_text,
        });
    ...
    async updateBanner(request: Request, response: Response) {
        ...
        const banner_in_text = fs
            .readFileSync(path.resolve(banner.path))
            .toString('base64');
    ...
    async updateCard(request: Request, response: Response) {
        ...
        const card_in_text = fs
            .readFileSync(path.resolve(card.path))
            .toString('base64');

        const eventRepository = new EventRepository();
        const eventAttachmentsRepository = new EventAttachmentRepository();
        const updateEventCardUsecase = new UpdateEventCardUsecase(
            eventRepository,
            eventAttachmentsRepository
        );
    ...
    async getEventBannerData(request: Request, response: Response) {
        const { event_id, banner_archive_id } = request.params;

        const eventRepository = new EventRepository();
        const eventAttachmentRepository = new EventAttachmentRepository();
        const getEventBannerDataUsecase = new GetEventBannerDataUsecase(
            eventRepository,
    ...
    async getEventCardData(request: Request, response: Response) {
        const { event_id, card_archive_id } = request.params;

        const eventRepository = new EventRepository();
        const eventAttachmentRepository = new EventAttachmentRepository();
        const getEventCardDataUsecase = new GetEventCardDataUsecase(
            eventRepository,
            eventAttachmentRepository
        );
    ...
    async getEventBanner(request: Request, response: Response) {
        const { file_name, banner_archive_id } = request.params;

        const eventAttachmentRepository = new EventAttachmentRepository();
        const getEventBannerArchiveUsecase = new GetEventBannerArchiveUsecase(
            eventAttachmentRepository
        );
        ...
        return response.send(
            Buffer.from(result.event_banner.archive, 'base64')
        );
    }

    async getEventCard(request: Request, response: Response) {
        const { file_name, card_archive_id } = request.params;

        const eventAttachmentRepository = new EventAttachmentRepository();
        const getEventCardArchiveUsecase = new GetEventCardArchiveUsecase(
            eventAttachmentRepository
        );
    ...
    async updateEventParameters(request: Request, response: Response) {
        ...
        const updateEventParametersUsecase = new UpdateEventParametersUsecase(
            eventRepository,
            eventParametersRepository
        );
    ...
    async getEventParameters(request: Request, response: Response) {
        ...
        const eventRepository = new EventRepository();
        const eventParametersRepository = new EventParametersRepository();
        const getEventParametersUsecase = new GetEventParametersUsecase(
            eventRepository,
            eventParametersRepository
        );
